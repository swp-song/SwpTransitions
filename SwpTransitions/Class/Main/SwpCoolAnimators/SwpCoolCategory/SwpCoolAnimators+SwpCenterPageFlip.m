//
//  SwpCoolAnimators+SwpCenterPageFlip.m
//  swp_song
//
...
#import "SwpCoolAnimators+SwpCenterPageFlip.h"

/* ---------------------- Tool       ---------------------- */
#import "UIView+SwpAnimatorsSnapshot.h"
/* ---------------------- Tool       ---------------------- */

@implementation SwpCoolAnimators (SwpCenterPageFlip)
...
- (void)swpCoolCenterPageFlipAnimation:(id<UIViewControllerContextTransitioning>)transitionContext pageFlipEdge:(SwpCoolCenterPageFlipEdge)pageFlipEdge {
    [self _animation:transitionContext pageFlipEdge:pageFlipEdge duration:self.transitionsToDuration];
...
- (void)swpCoolCenterPageFlipBackAnimation:(id<UIViewControllerContextTransitioning>)transitionContext pageFlipEdge:(SwpCoolCenterPageFlipEdge)pageFlipEdge {
    [self _animation:transitionContext pageFlipEdge:pageFlipEdge duration:self.transitionsBackDuration];
 ...
 *  @author swp_song
 *
 *  @brief  _animation:pageFlipEdge:duration:   ( 转场核心动画 )
 *
 *  @param  transitionContext   transitionContext
 *
 *  @param  pageFlipEdge        pageFlipEdge
 ...
 */
- (void)_animation:(id<UIViewControllerContextTransitioning>)transitionContext pageFlipEdge:(SwpCoolCenterPageFlipEdge)pageFlipEdge duration:(NSTimeInterval)duration {
    ...
    NSArray *toViewSnapshots    = [self _animationSnapFlipView:toView pageFlipEdge:pageFlipEdge update:YES];
    UIView  *animationToView    = toViewSnapshots[animation ? 1 : 0];
    NSArray *fromViewSnapshots  = [self _animationSnapFlipView:fromView pageFlipEdge:pageFlipEdge update:NO];
    UIView  *animationFromView  = fromViewSnapshots[animation ? 0 : 1];
    [self _addShadowWithPageFlipEdge:pageFlipEdge fromView:animationFromView toView:animationToView];
    [self _anchorPointWithPageFlipEdge:pageFlipEdge fromView:animationFromView toView:animationToView];
...
- (NSArray<UIView *> *)_animationSnapFlipView:(UIView *)view pageFlipEdge:(SwpCoolCenterPageFlipEdge)pageFlipEdge update:(BOOL)update {
...
- (void)_anchorPointWithPageFlipEdge:(SwpCoolCenterPageFlipEdge)pageFlipEdge fromView:(UIView *)fromView toView:(UIView *)toView {
    switch (pageFlipEdge) {
        case SwpCoolCenterPageFlipEdgeLeft: {
            [self _anchorToPoint:CGPointMake(1, 0.5) forView:fromView];
            [self _anchorToPoint:CGPointMake(0, 0.5) forView:toView];
            break;
        }
        case SwpCoolCenterPageFlipEdgeRight: {
            [self _anchorToPoint:CGPointMake(0, 0.5) forView:fromView];
            [self _anchorToPoint:CGPointMake(1, 0.5) forView:toView];
            break;
        }
        case SwpCoolCenterPageFlipEdgeTop: {
            [self _anchorToPoint:CGPointMake(0.5, 1) forView:fromView];
            [self _anchorToPoint:CGPointMake(0.5, 0) forView:toView];
            break;
        }
        case SwpCoolCenterPageFlipEdgeBottom: {
            [self _anchorToPoint:CGPointMake(0.5, 0) forView:fromView];
            [self _anchorToPoint:CGPointMake(0.5, 1) forView:toView];
            break;
        }
    }
}
...
- (void)_addShadowWithPageFlipEdge:(SwpCoolCenterPageFlipEdge)pageFlipEdge fromView:(UIView *)fromView toView:(UIView *)toView {
    ...
    [self _addGrandientLayerWithStartPoint:fstartP endPoint:fendP forView:fromView].alpha   = 0.0f;
    [self _addGrandientLayerWithStartPoint:tstartP endPoint:tendP forView:toView].alpha     = 1.0f;
}


- (UIView *)_addGrandientLayerWithStartPoint:(CGPoint)startPoint endPoint:(CGPoint)endPoint forView:(UIView *)view {
...
- (void)_anchorToPoint:(CGPoint)point forView:(UIView *)view {
