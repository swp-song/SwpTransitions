...
FOUNDATION_STATIC_INLINE UIView * SlideEjectToAnimation(id<UIViewControllerContextTransitioning> transitionContext, NSTimeInterval duration, SwpDrawerAnimatorDirection direction, CGFloat aDistance, BOOL vertical, CGFloat stepOneScale, CGFloat stepTwoScale) {
    ...
    NSInteger   symbol          = direction == SwpDrawerAnimatorDirectionLeft || direction == SwpDrawerAnimatorDirectionTop ? -1 : 1;
...
/* 返回，抽屉弹出动画效果 */
FOUNDATION_STATIC_INLINE void SlideEjectBackAnimation(id<UIViewControllerContextTransitioning> transitionContext, NSTimeInterval duration, UIView *tempView, UIView *gestureView, SwpDrawerAnimatorDirection direction, BOOL vertical, CGFloat stepOneScale) {
...
/*  计算移动距离 */
FOUNDATION_STATIC_INLINE CGFloat _SlideEjectMoveMaxDistance(UIView *containerView, SwpDrawerAnimatorDirection direction, CGFloat distance) {
...
FOUNDATION_STATIC_INLINE CATransform3D _SlideEjectStepTwoTransform(UIView *view, SwpDrawerAnimatorDirection direction, BOOL vertical, CGFloat stepOneScale, CGFloat stepTwoScale) {
...
FOUNDATION_STATIC_INLINE CATransform3D _SlideEjectStepOneTransform(SwpDrawerAnimatorDirection direction, BOOL vertical, CGFloat stepOneScale) {
