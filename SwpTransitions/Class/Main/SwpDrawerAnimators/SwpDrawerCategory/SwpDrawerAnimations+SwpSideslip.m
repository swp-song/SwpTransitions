...
/* 跳转，抽屉左右侧滑动画效果 */
FOUNDATION_STATIC_INLINE UIView * _SideslipToAnimation(id<UIViewControllerContextTransitioning> transitionContext, NSTimeInterval duration, SwpDrawerAnimatorDirection direction, CGFloat aDistance, BOOL vertical, CGFloat scaleRatio) {
...
/*  计算移动距离 */
 FOUNDATION_STATIC_INLINE CGFloat _SideslipMoveMaxDistance(UIView *containerView, SwpDrawerAnimatorDirection direction, CGFloat distance) {
