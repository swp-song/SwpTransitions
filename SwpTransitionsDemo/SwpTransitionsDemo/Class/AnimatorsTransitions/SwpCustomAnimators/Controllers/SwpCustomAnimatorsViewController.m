//
//  SwpCustomAnimatorsViewController.m
//  SwpTransitionsDemo
//
...
#import "SwpCustomAnimatorsViewController.h"
...
/* ---------------------- Model      ---------------------- */
#import "SwpCustomAnimatorsModel.h"
/* ---------------------- Model      ---------------------- */
...
@interface SwpCustomAnimatorsViewController ()
...
@implementation SwpCustomAnimatorsViewController
...
- (void)viewDidLoad {
    ...
    [self swpCustomAnimatorsViewControllerBlock];
}
 ...
 *  @author swp_song
 *
 *  @brief  swpCustomAnimatorsViewControllerBlock   ( SwpCustomAnimatorsViewController Block )
 */
- (void)swpCustomAnimatorsViewControllerBlock {
...
- (void)swpTransitionsTableViewBlock:(SwpTransitionsTableView *)swpTransitionsTableView {
    ...
    swpTransitionsTableView.swpTransitionsTableViewClickCellEventChain(^(SwpTransitionsTableView *swpTransitionsTableView, NSIndexPath *indexPath, SwpCustomAnimatorsModel *model){
        __strong __typeof(weakSelf)strongSelf = weakSelf;
        SwpCustomAnimatorsToViewController *swpCustomAnimatorsToViewController = [SwpCustomAnimatorsToViewController new];
        [strongSelf.navigationController pushViewController:swpCustomAnimatorsToViewController animated:YES];
    });
}
...
- (NSArray *)datas_ {
    ...
    return !_datas_ ? _datas_ = ({
        [SwpCustomAnimatorsModel swpTransitionsWithDictionarys:[NSArray arrayWithContentsOfFile:[NSBundle.mainBundle pathForResource:@"SwpCustomAnimatorsModel" ofType:@"plist"]]];
    }) : _datas_;
