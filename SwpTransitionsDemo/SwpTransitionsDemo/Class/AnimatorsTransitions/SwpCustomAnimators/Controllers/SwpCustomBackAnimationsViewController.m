//
//  SwpCustomAnimatorsBackViewController.m
//  SwpTransitionsDemo
//
...
@interface SwpCustomBackAnimationsViewController ()
...
@implementation SwpCustomBackAnimationsViewController
...
- (void)viewDidLoad {
    ...
    .swpTransitionsAnimationsViewControllerClickButtonEvent(^(UIButton *button, BOOL isClickSwitch) {
        ...
        [strongSelf swpTransitionsBackAnimationsViewController];
    });
}
