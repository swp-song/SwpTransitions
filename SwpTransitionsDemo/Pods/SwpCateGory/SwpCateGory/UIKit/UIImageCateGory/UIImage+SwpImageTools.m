...
+ (UIImage * _Nonnull (^)(void))swpImageToolsSnapshotFullScreenImageChain {
    ...
    return ^(){
        return [self.class swpImageToolsSnapshotFullScreenImage];
    };
}
...
+ (UIImage *)swpImageToolsSnapshotFullScreenImage {
    return [UIImage imageWithData:[self.class swpImageToolsSnapshotFullScreenData]];
}
 ...
 *  @author swp_song
 *
 *  @brief  swpImageToolsSnapshotFullScreenData ( 截取整个屏幕，转换成 Data )
 *
 *  @return NSData
 */
+ (NSData *)swpImageToolsSnapshotFullScreenData {
